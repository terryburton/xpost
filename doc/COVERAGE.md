...
| `src/lib/xpost_dsc_file.c` | 31.91% | 47 | 32 |
| `src/lib/xpost_op_type.c` | 90.14% | 284 | 28 |
...
| `src/lib/xpost_compat.c` | 68.18% | 22 | 7 |
...
- `nullenc_writech`
- `rsd_flush`
- `xpost_file_cons_filter_enc_null`
- `xpost_file_flush`
- `xpost_strbuf_free`
...
- `_strike_resample`
- `xpost_font_cache_setlimit`
- `xpost_font_cache_setparams`
