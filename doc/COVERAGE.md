...
**81.1% of 18532 lines** and **64.0% of 13330 branch outcomes**, across
49 files. 4794 outcomes are never taken.
...
|---:|---|---:|---|
| 821,617,780 | `src/lib/xpost_interpreter.c:707` | 2 of 4 | `if (btype == invalidtype \|\| btype >= XPOST_OBJECT_NTYPES)` |
| 821,617,780 | `src/lib/xpost_interpreter.c:697` | 1 of 2 | `if (abase)` |
| 821,617,780 | `src/lib/xpost_interpreter.c:675` | 1 of 2 | `if (ctx->quit)` |
| 619,691,024 | `src/lib/xpost_op_path.c:225` | 1 of 2 | `if (esz > used - o)   /* the element must fit the declared ...` |
| 619,691,024 | `src/lib/xpost_op_path.c:222` | 2 of 4 | `if (p[o] < PATH_CMD_MOVE \|\| p[o] > PATH_CMD_CLOSE)` |
| 506,046,320 | `src/lib/xpost_memory.c:925` | 1 of 2 | `CHECK_VALID_ENT(ent,mem,0)` |
| 456,281,322 | `src/lib/xpost_stack.c:134` | 1 of 2 | `if (xpost_object_get_type(obj) == invalidtype)` |
| 434,997,618 | `src/lib/xpost_free.c:296` | 2 of 4 | `if (e > XPOST_OBJECT_COMP_MAX_ENT \|\|` |
| 308,533,244 | `src/lib/xpost_interpreter.c:1113` | 2 of 4 | `slot.comp_.off != off + 1 \|\|` |
| 303,703,313 | `src/lib/xpost_stack.c:181` | 1 of 2 | `if (s->prevseg) s = xpost_stack_at(mem, s->prevseg); /* fin...` |
| 283,509,965 | `src/lib/xpost_interpreter.c:820` | 1 of 4 | `if (w == (unsigned int)XPOST_OP_CODE(ctx, optype) && ot >= 1)` |
| 259,150,112 | `src/lib/xpost_operator.c:1050` | 1 of 4 | `if (!sp[i].fp && (xpost_object_get_type(op.proc) == arrayty...` |
| 258,814,430 | `src/lib/xpost_operator.c:709` | 1 of 2 | `assert(n < XPOST_STACK_SEGMENT_SIZE);` |
| 258,814,430 | `src/lib/xpost_operator.c:1077` | 1 of 10 | `switch(sp[i].in)` |
| 244,114,300 | `src/lib/xpost_dict.c:229` | 1 of 2 | `if (xpost_object_is_composite(k))` |
| 240,610,838 | `src/lib/xpost_memory.c:832` | 1 of 2 | `CHECK_VALID_ENT(ent,mem,0)` |
| 232,016,840 | `src/lib/xpost_object.c:215` | 1 of 4 | `if (type == dicttype && xpost_object_dict_get_access)` |
| 217,498,809 | `src/lib/xpost_memory.c:854` | 1 of 2 | `CHECK_VALID_ENT(ent,mem,0)` |
| 217,498,809 | `src/lib/xpost_free.c:316` | 1 of 2 | `if (!ret)` |
| 217,498,809 | `src/lib/xpost_free.c:298` | 1 of 2 | `mem->table.tab[e].tag != 0)` |
| 216,002,252 | `src/lib/xpost_memory.c:900` | 1 of 2 | `CHECK_VALID_ENT(ent,mem,0)` |
| 211,772,250 | `src/lib/xpost_free.c:338` | 1 of 2 | `if (!ret)` |
...
| 198,474,927 | `src/lib/xpost_interpreter.c:1079` | 11 of 30 | `EVALARRAY_SYNC_SLOT();` |
| 195,073,969 | `src/lib/xpost_object.c:217` | 1 of 4 | `else if (type == filetype && xpost_object_file_get_access)` |
| 189,727,495 | `src/lib/xpost_interpreter.c:1385` | 2 of 4 | `if (type == invalidtype \|\| type >= XPOST_OBJECT_NTYPES)` |
| 189,727,495 | `src/lib/xpost_interpreter.c:1364` | 1 of 2 | `if (_xpost_interpreter_is_tracing)` |
| 185,150,180 | `src/lib/xpost_interpreter.c:1089` | 1 of 2 | `if (_xpost_interpreter_is_tracing)` |
| 175,636,282 | `src/lib/xpost_dict.c:586` | 1 of 4 | `if (xpost_object_get_type(a) == nametype &&` |
| 168,798,375 | `src/lib/xpost_memory.c:951` | 1 of 2 | `if ((unsigned long long)offset * sz + sz > mem->table.tab[e...` |
| 168,798,375 | `src/lib/xpost_memory.c:949` | 1 of 2 | `CHECK_VALID_ENT(ent,mem,0)` |
| 163,402,782 | `src/lib/xpost_dict.c:729` | 1 of 2 | `if (!dp)` |
| 154,266,622 | `src/lib/xpost_interpreter.c:1112` | 1 of 2 | `slot.comp_.sz != remaining - 1 \|\|` |
| 154,266,622 | `src/lib/xpost_interpreter.c:1111` | 1 of 2 | `if (slot.tag != a.comp_.tag \|\|` |
| 117,903,932 | `src/lib/xpost_op_stack.c:119` | 1 of 2 | `if (!xpost_stack_push(ctx->lo, ctx->os, src[i]))` |
| 110,172,055 | `src/lib/xpost_interpreter.c:668` | 2 of 4 | `EVALARRAY_RESOLVE_ABASE();` |
| 104,762,037 | `src/lib/xpost_dict.c:646` | 1 of 6 | `RETURN_TAB_I_IF_EQ_K_OR_NULL;` |
| 104,762,037 | `src/lib/xpost_dict.c:644` | 1 of 2 | `for (i = 0; i < h; i++)` |
...
| `src/lib/xpost_op_font.c` | 2284 | 80.39% | 60.16% | 448 |
| `src/lib/xpost_interpreter.c` | 1135 | 81.32% | 59.86% | 212 |
...
| `src/lib/xpost_op_file.c` | 948 | 86.81% | 66.07% | 125 |
